...
<template>
  <div class="macros__nodes">
    <div class="macro__node">
      <div>
        <span
          class="bg-n-solid-teal text-n-teal-11 py-1 px-1.5 leading-none text-sm rounded-md"
        >
...
.macros__nodes-draggable:after {
  @apply border-l dark:border-n-teal-11 border-n-teal-7 border-dashed ltr:ml-6 rtl:mr-6 absolute h-8 w-1 content-[""];
}
