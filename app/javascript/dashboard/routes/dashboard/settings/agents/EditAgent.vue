        ...
        <div class="grid grid-cols-2 gap-3">
          ...
          >
            <span
              ...
              >{{ $t('AGENT_MGMT.EDIT.FORM.NAME.LABEL') }}</span
            >
            <input
              v-model="agentName"
              type="text"
          ...
          >
            <span
              ...
              >{{ $t('AGENT_MGMT.EDIT.FORM.AGENT_TYPE.LABEL') }}</span
            >
            <select
          ...
          >
            <span
              class="text-[10px] font-semibold tracking-[0.15em] text-n-slate-10 uppercase"
              >{{ $t('PROFILE_SETTINGS.FORM.AVAILABILITY.LABEL') }}</span
            >
            <select
